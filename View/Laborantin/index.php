            ...
            <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                    ...
                    <table class="table datatable text-center">
                        ...
                        <tbody>
                            <?php foreach ($Laborantins as $m): ?>
                                <tr>
                                    <td><?= $m['IdLaborantin'] ?></td>
                                    ...
                                    <td>
                                        <a class="text-info mx-1" href="#" onclick='openLaborantinModal(<?= json_encode($m) ?>)'>
                                            <span class="badge bg-success"><i class="bi bi-pencil-square fa-lg"></i></span>
                                        </a>
                                        <a class="text-danger mx-1" href="?delete=<?= $m['IdLaborantin'] ?>" onclick="return confirm('Voulez-vous vraiment supprimer ?')">
...
<script>
function openLaborantinModal(m) {
    const isEdit = m !== null;
    document.getElementById('IdLaborantin').value = isEdit ? m.IdLaborantin : '';
